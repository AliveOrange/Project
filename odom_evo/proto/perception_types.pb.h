...
#ifndef PROTOBUF_INCLUDED_perception_5ftypes_2eproto
#define PROTOBUF_INCLUDED_perception_5ftypes_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_perception_5ftypes_2eproto 
...
namespace google {
namespace protobuf {
template<> ::calmcar::perception::Matrix2d* Arena::CreateMaybeMessage<::calmcar::perception::Matrix2d>(Arena*);
template<> ::calmcar::perception::Point* Arena::CreateMaybeMessage<::calmcar::perception::Point>(Arena*);
template<> ::calmcar::perception::Point2i* Arena::CreateMaybeMessage<::calmcar::perception::Point2i>(Arena*);
template<> ::calmcar::perception::Rect* Arena::CreateMaybeMessage<::calmcar::perception::Rect>(Arena*);
template<> ::calmcar::perception::Size2f* Arena::CreateMaybeMessage<::calmcar::perception::Size2f>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace calmcar {
namespace perception {
...
#endif  // PROTOBUF_INCLUDED_perception_5ftypes_2eproto
