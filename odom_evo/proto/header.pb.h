...
namespace google {
namespace protobuf {
template<> ::Calmcar::common::Header* Arena::CreateMaybeMessage<::Calmcar::common::Header>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace Calmcar {
namespace common {
...
class Header : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Calmcar.common.Header) */ {
 public:
  Header();
  virtual ~Header();
  ...
  // @@protoc_insertion_point(class_scope:Calmcar.common.Header)
 private:
...
inline double Header::timestamp_sec() const {
  // @@protoc_insertion_point(field_get:Calmcar.common.Header.timestamp_sec)
  return timestamp_sec_;
}
inline void Header::set_timestamp_sec(double value) {
  
  timestamp_sec_ = value;
  // @@protoc_insertion_point(field_set:Calmcar.common.Header.timestamp_sec)
}
...
inline const ::std::string& Header::module_name() const {
  // @@protoc_insertion_point(field_get:Calmcar.common.Header.module_name)
...
inline void Header::set_module_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Calmcar.common.Header.module_name)
}
#if LANG_CXX11
inline void Header::set_module_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:Calmcar.common.Header.module_name)
}
#endif
inline void Header::set_module_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:Calmcar.common.Header.module_name)
}
inline void Header::set_module_name(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Calmcar.common.Header.module_name)
}
inline ::std::string* Header::mutable_module_name() {
  
  // @@protoc_insertion_point(field_mutable:Calmcar.common.Header.module_name)
...
inline ::std::string* Header::release_module_name() {
  // @@protoc_insertion_point(field_release:Calmcar.common.Header.module_name)
...
inline void Header::set_allocated_module_name(::std::string* module_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Calmcar.common.Header.module_name)
}
...
inline ::google::protobuf::uint32 Header::sequence_num() const {
  // @@protoc_insertion_point(field_get:Calmcar.common.Header.sequence_num)
  return sequence_num_;
}
inline void Header::set_sequence_num(::google::protobuf::uint32 value) {
  
  sequence_num_ = value;
  // @@protoc_insertion_point(field_set:Calmcar.common.Header.sequence_num)
}
...
inline ::google::protobuf::uint64 Header::lidar_timestamp() const {
  // @@protoc_insertion_point(field_get:Calmcar.common.Header.lidar_timestamp)
  return lidar_timestamp_;
}
inline void Header::set_lidar_timestamp(::google::protobuf::uint64 value) {
  
  lidar_timestamp_ = value;
  // @@protoc_insertion_point(field_set:Calmcar.common.Header.lidar_timestamp)
}
...
inline ::google::protobuf::uint64 Header::camera_timestamp() const {
  // @@protoc_insertion_point(field_get:Calmcar.common.Header.camera_timestamp)
  return camera_timestamp_;
}
inline void Header::set_camera_timestamp(::google::protobuf::uint64 value) {
  
  camera_timestamp_ = value;
  // @@protoc_insertion_point(field_set:Calmcar.common.Header.camera_timestamp)
}
...
inline ::google::protobuf::uint64 Header::radar_timestamp() const {
  // @@protoc_insertion_point(field_get:Calmcar.common.Header.radar_timestamp)
  return radar_timestamp_;
}
inline void Header::set_radar_timestamp(::google::protobuf::uint64 value) {
  
  radar_timestamp_ = value;
  // @@protoc_insertion_point(field_set:Calmcar.common.Header.radar_timestamp)
}
...
inline ::google::protobuf::uint32 Header::version() const {
  // @@protoc_insertion_point(field_get:Calmcar.common.Header.version)
  return version_;
}
inline void Header::set_version(::google::protobuf::uint32 value) {
  
  version_ = value;
  // @@protoc_insertion_point(field_set:Calmcar.common.Header.version)
}
