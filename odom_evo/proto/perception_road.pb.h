...
#ifndef PROTOBUF_INCLUDED_perception_5froad_2eproto
#define PROTOBUF_INCLUDED_perception_5froad_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_perception_5froad_2eproto 
...
namespace google {
namespace protobuf {
template<> ::calmcar::perception::FreeSpace* Arena::CreateMaybeMessage<::calmcar::perception::FreeSpace>(Arena*);
template<> ::calmcar::perception::FreeSpaceImagePoint* Arena::CreateMaybeMessage<::calmcar::perception::FreeSpaceImagePoint>(Arena*);
template<> ::calmcar::perception::FreeSpacePoint* Arena::CreateMaybeMessage<::calmcar::perception::FreeSpacePoint>(Arena*);
template<> ::calmcar::perception::Lane* Arena::CreateMaybeMessage<::calmcar::perception::Lane>(Arena*);
template<> ::calmcar::perception::LaneAdjacent* Arena::CreateMaybeMessage<::calmcar::perception::LaneAdjacent>(Arena*);
template<> ::calmcar::perception::LaneHost* Arena::CreateMaybeMessage<::calmcar::perception::LaneHost>(Arena*);
template<> ::calmcar::perception::LaneRoadedge* Arena::CreateMaybeMessage<::calmcar::perception::LaneRoadedge>(Arena*);
template<> ::calmcar::perception::RoadMark* Arena::CreateMaybeMessage<::calmcar::perception::RoadMark>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace calmcar {
namespace perception {
...
class LaneHost : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:calmcar.perception.LaneHost) */ {
 public:
  ...
  inline LaneHost* New() const final {
    return CreateMaybeMessage<LaneHost>(NULL);
  }

  LaneHost* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<LaneHost>(arena);
  }
...
class LaneAdjacent : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:calmcar.perception.LaneAdjacent) */ {
 public:
  ...
  inline LaneAdjacent* New() const final {
    return CreateMaybeMessage<LaneAdjacent>(NULL);
  }

  LaneAdjacent* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<LaneAdjacent>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class LaneRoadedge : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:calmcar.perception.LaneRoadedge) */ {
 public:
  ...
  inline LaneRoadedge* New() const final {
    return CreateMaybeMessage<LaneRoadedge>(NULL);
  }

  LaneRoadedge* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<LaneRoadedge>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class FreeSpaceImagePoint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:calmcar.perception.FreeSpaceImagePoint) */ {
 public:
  ...
  inline FreeSpaceImagePoint* New() const final {
    return CreateMaybeMessage<FreeSpaceImagePoint>(NULL);
  }

  FreeSpaceImagePoint* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<FreeSpaceImagePoint>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  ...
  private:
  const ::calmcar::perception::Point2i& _internal_image_point() const;
  public:
...
class FreeSpacePoint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:calmcar.perception.FreeSpacePoint) */ {
 public:
  ...
  inline FreeSpacePoint* New() const final {
    return CreateMaybeMessage<FreeSpacePoint>(NULL);
  }

  FreeSpacePoint* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<FreeSpacePoint>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class FreeSpace : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:calmcar.perception.FreeSpace) */ {
 public:
  ...
  inline FreeSpace* New() const final {
    return CreateMaybeMessage<FreeSpace>(NULL);
  }

  FreeSpace* New(::google::protobuf::Arena* arena) const final {
...
inline const ::calmcar::perception::Rect& RoadMark::_internal_bbox() const {
  return *bbox_;
}
...
inline const ::calmcar::perception::Point2i& FreeSpaceImagePoint::_internal_image_point() const {
  return *image_point_;
}
...
inline ::calmcar::perception::Point2i* FreeSpaceImagePoint::mutable_image_point() {
  ...
  if (image_point_ == NULL) {
    auto* p = CreateMaybeMessage<::calmcar::perception::Point2i>(GetArenaNoVirtual());
    image_point_ = p;
  }
...
template <> struct is_proto_enum< ::calmcar::perception::LineColor> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::calmcar::perception::LineColor>() {
  return ::calmcar::perception::LineColor_descriptor();
}
template <> struct is_proto_enum< ::calmcar::perception::LineQuality> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::calmcar::perception::LanemarkType> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_perception_5froad_2eproto
