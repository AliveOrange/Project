...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_perception_5fvehicle_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_DashBoard;
}  // namespace protobuf_perception_5fvehicle_2eproto
namespace calmcar {
...
::google::protobuf::internal::SCCInfo<1> scc_info_Vehicle =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsVehicle}, {
      &protobuf_perception_5fvehicle_2eproto::scc_info_DashBoard.base,}};
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "perception_vehicle.proto", schemas, file_default_instances, TableStruct::offsets,
...
const DashBoard& DashBoard::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_perception_5fvehicle_2eproto::scc_info_DashBoard.base);
...
const Vehicle& Vehicle::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_perception_5fvehicle_2eproto::scc_info_Vehicle.base);
  return *internal_default_instance();
}
...
void Vehicle::SerializeWithCachedSizes(
  ...
  if (this->has_dash_board()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->_internal_dash_board(), output);
  }
  ...
  if (this->has_dash_board()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, this->_internal_dash_board(), deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::calmcar::perception::DashBoard* Arena::CreateMaybeMessage< ::calmcar::perception::DashBoard >(Arena* arena) {
  return Arena::CreateInternal< ::calmcar::perception::DashBoard >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::calmcar::perception::Vehicle* Arena::CreateMaybeMessage< ::calmcar::perception::Vehicle >(Arena* arena) {
  return Arena::CreateInternal< ::calmcar::perception::Vehicle >(arena);
}
}  // namespace protobuf
}  // namespace google
