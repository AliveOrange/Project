...
static void InitDefaultsBarricade() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_Barricade =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsBarricade}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_Barricade.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "perception_barricade.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "rception\032\034perception_sensor_info.proto\"\327"
      ...
      "\023 \001(\002\022\031\n\021long_distance_std\030\024 \001(\002b\006proto3"
  };
...
Barricade::Barricade(const Barricade& from)
  ...
  ::memcpy(&frame_index_, &from.frame_index_,
    static_cast<size_t>(reinterpret_cast<char*>(&long_distance_std_) -
    reinterpret_cast<char*>(&frame_index_)) + sizeof(long_distance_std_));
...
void Barricade::SharedCtor() {
  ...
  ::memset(&frame_index_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&long_distance_std_) -
      reinterpret_cast<char*>(&frame_index_)) + sizeof(long_distance_std_));
}
...
const Barricade& Barricade::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_perception_5fbarricade_2eproto::scc_info_Barricade.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::calmcar::perception::Barricade* Arena::CreateMaybeMessage< ::calmcar::perception::Barricade >(Arena* arena) {
  return Arena::CreateInternal< ::calmcar::perception::Barricade >(arena);
}
}  // namespace protobuf
}  // namespace google
