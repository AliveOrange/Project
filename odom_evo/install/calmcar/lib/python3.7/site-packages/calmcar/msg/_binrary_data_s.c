...
bool calmcar__msg__binrary_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("calmcar.msg._binrary_data.BinraryData", full_classname_dest, 37) == 0);
  }
  calmcar__msg__BinraryData * ros_message = _ros_message;
  {  // size
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * calmcar__msg__binrary_data__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of BinraryData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("calmcar.msg._binrary_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BinraryData");
  ...
  calmcar__msg__BinraryData * ros_message = (calmcar__msg__BinraryData *)raw_ros_message;
  {  // size
    PyObject * field = NULL;
