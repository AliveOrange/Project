...
bool calmcar__msg__cache_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("calmcar.msg._cache_data.CacheData", full_classname_dest, 33) == 0);
  }
  calmcar__msg__CacheData * ros_message = _ros_message;
  {  // type
  ...
  {  // methods
    ...
    ros_message->methods = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // size
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * calmcar__msg__cache_data__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of CacheData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("calmcar.msg._cache_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CacheData");
  ...
  calmcar__msg__CacheData * ros_message = (calmcar__msg__CacheData *)raw_ros_message;
  {  // type
    PyObject * field = NULL;
  ...
  {  // methods
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->methods);
    {
